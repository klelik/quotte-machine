  ...
  return (
    <div className="App">
      <header className="App-header" style={{backgroundColor:randomColor}}>
        ...
        <a className="buttonEffect"  id='tweet-quote' style={{backgroundColor:randomColor}} href={encodeURI(`https://twitter.com/intent/tweet?text=${quote}-${author}&hashtags=quote`)}><FaTwitter /></a>
        <button className="buttonEffect" id='new-quote' style={{backgroundColor:randomColor}} onClick={()=>getRandomQuote()}>Generate New Quote</button>
        </div>
